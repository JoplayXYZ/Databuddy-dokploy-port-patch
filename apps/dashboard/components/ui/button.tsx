...
const buttonVariants = cva(
	"inline-flex shrink-0 cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded font-medium text-sm outline-none transition-all focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:cursor-not-allowed aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
	{
		variants: {
			variant: {
				default:
				...
				destructive:
					"bg-destructive text-white hover:bg-destructive-brighter focus-visible:ring-destructive/20 disabled:bg-accent-disabled disabled:text-neutral-500",
				outline:
				...
				ghost:
					"hover:bg-accent hover:text-accent-foreground disabled:bg-accent-disabled/30 disabled:text-accent-foreground/20",
			},
			size: {
