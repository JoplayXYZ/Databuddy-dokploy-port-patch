...
| `websiteId` | string | No | Public website **client id** (same value as `data-client-id` in the tracker; string id from the dashboard, not necessarily a UUID). Alternative to `?website_id=` |
