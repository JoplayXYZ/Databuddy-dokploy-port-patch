...
The Databuddy SDK provides framework-specific components, helper functions, native Swift support, and a vanilla JavaScript library for tracking analytics events. Choose your preferred integration method.
...
<Cards>
  ...
  <Card title="Swift" href="/docs/sdk/swift">
    Native analytics for iOS, macOS, tvOS, and watchOS apps
  </Card>
</Cards>
...
| `Databuddy` | Swift Package Manager product for Apple apps |
