...
`@databuddy/nuxt` is a first-class Nuxt module. Add it to `nuxt.config.ts` once and you're done — pageviews, SPA navigation, and error tracking work automatically with no `app.vue` changes.
