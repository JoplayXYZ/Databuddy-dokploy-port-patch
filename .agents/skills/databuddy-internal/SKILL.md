...
- Slack routing is organization-scoped: OAuth binds a Slack workspace to a Databuddy organization, `/bind` only marks a Slack channel, and the Slack agent should use MCP-style website discovery instead of storing website/domain bindings.
