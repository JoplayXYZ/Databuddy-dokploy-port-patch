...
- Slack website routing should discover/list org websites, auto-select a single website, and give concrete `/bind <domain>` choices instead of making users guess exact domains or requiring a default website first.
